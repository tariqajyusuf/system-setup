...
if which apt; then
  ...
  curl -L -O https://code.visualstudio.com/sha/download?build=stable&os=linux-deb-x64 > vscode.deb 2> $OUTPUT
  ...
  curl -L -O https://code.visualstudio.com/sha/download?build=stable&os=cli-alpine-x64 > vscode.tar.gz 2> $OUTPUT
