...
if which apt; then
  ...
  curl -L -o vscode.deb "https://code.visualstudio.com/sha/download?build=stable&os=linux-deb-x64" 2> $OUTPUT
  ...
  curl -L -o vscode.deb "https://code.visualstudio.com/sha/download?build=stable&os=cli-alpine-x64" 2> $OUTPUT
